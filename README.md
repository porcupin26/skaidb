...
Making queries fast: **[docs/INDEXING.md](docs/INDEXING.md)** — every index
type, how the planner picks one, and how to read the slow-query log to spot
the index a workload is missing.
